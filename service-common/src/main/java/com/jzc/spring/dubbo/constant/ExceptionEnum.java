...
public enum ExceptionEnum {
    ...
    PIN_FREQUENTLY("5024", "PIN frequently sent, please try later.", "发送验证码过于频繁，请稍候再试！", ""),
    ...
    //朋友圈异常码由此开始
    /** 文本，图片，视频，音频不能同时为空 */
    FEEDS_NOT_NULL("8001", "", "文本，图片，视频，音频不能同时为空", ""),
    /** 视频长度不能为空 */
    FEEDS_VIDEOLENGTH_NULL("8002", "", "视频长度不能为空", ""),
    /** 音频长度不能为空 */
    FEEDS_AUDIOLENGTH_NULL("8003", "", "音频长度不能为空", ""),
    ...
    ExceptionEnum(String code, String msg, String errorMsg, String zhMsg) {
        this.code = code;
        this.msg = msg;
        this.errorMsg = errorMsg;
        this.zhMsg = zhMsg;
